...
# ─────────────────────────────────────────────────────────────────────────
# Corpus-specific tuning is DERIVED FROM YOUR DOCUMENTS.
#
# The extraction vocabulary, entity-resolution rules and structural reference
# patterns all depend on what your corpus actually contains, so nobody can
# write them before knowing it. 'kash build' measures them and writes
# data/domain.profile.json. Run 'kash profile' to see what it decided and why.
#
# Configuration is layered, and this file always wins:
#
#     built-in defaults  <  data/domain.profile.json  <  agent.yaml
#
# So you only add a block below when you disagree with what was measured.
# Setting a list here REPLACES the derived one; it does not merge.
# Re-derive with 'kash build --refresh-profile'.
#
# extraction:
...
#   strip_final_vowel: false # Sanskrit convention; wrong for most languages
#   honorifics: ["dr. ", "prof. "]
#
# chunker:
#   ref_patterns:
