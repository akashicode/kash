...
func runInit(cmd *cobra.Command, args []string) error {
	...
	fmt.Printf("  4. Run: agent-forge build\n")
...
# Generated by: agent-forge init %s
...
# MCP tool definitions (auto-populated by 'agent-forge build')
mcp:
  tools:
    - name: "search_%s_knowledge"
      ...
      # NOTE: This description will be auto-optimized by 'agent-forge build'
...
COPY --from=ghcr.io/agent-forge/runtime:latest /agent-forge-server /app/agent-forge-server

# Copy the compiled database artifacts from 'agent-forge build'
...
ENTRYPOINT ["/app/agent-forge-server"]
`
}
